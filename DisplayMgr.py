class DisplayMgr:
    ...
    def print_generation(self, population): #some parts of this function could be missing, some of the code cut off in the video
        ...
        for i in range(0, len(schedules)):
            table1.add_row([str(i), round(schedules[i].getfitness(),3), schedules[i].getnumbOfConflicts(), schedules[i]])
        print(table1)
    def print_schedules_as_table(self, schedule): #some parts of this function could be missing, some of the code cut off in the video
